...
export default function UtilityToolLayout({
  title,
  description,
      ...
      <main className="pt-28 pb-20 flex-grow max-w-6xl w-full mx-auto px-6">
        ...
        <div className="mb-6 animate-fade-in">
          <nav className="flex flex-wrap items-center gap-1.5 text-[10px] font-extrabold uppercase tracking-widest text-zinc-500 dark:text-zinc-400">
            ...
            <span className="material-symbols-outlined text-[12px] select-none">chevron_right</span>
            <Link href="/tools/utility-tools" className="hover:text-purple-500 transition-colors text-zinc-500 dark:text-zinc-400">Utility Tools</Link>
            <span className="material-symbols-outlined text-[12px] select-none">chevron_right</span>
                  ...
                  <div className="actions-card text-center lg:text-left flex flex-col h-full justify-between">
                    ...
                    {onReset && (
                      <div className="mt-8 pt-4 border-t border-border-subtle">
                        <button
                          onClick={onReset}
                          className="w-full py-2.5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 hover:border-purple-500/40 hover:text-purple-500 rounded-xl font-bold transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer text-xs"
                        >
