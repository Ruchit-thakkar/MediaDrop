    ...
    >
      <div className="flex items-center gap-3.5">
        ...
        <div className="flex flex-col">
          <span className="text-white font-extrabold text-sm tracking-tight leading-tight">
            {title}
          </span>
      ...
      <div className="flex items-center gap-5">
        {/* File Size */}
        <span className="text-xs font-semibold text-zinc-400 tracking-tight font-mono select-all">
          {fileSize}
        </span>
