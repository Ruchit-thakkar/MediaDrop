...
// High-quality official SVGs for social platforms with original colors
  ...
  <svg viewBox="0 0 24 24" className={className}>
    <defs>
      <radialGradient id="ig-grad" cx="30%" cy="107%" r="130%">
        <stop offset="0" stopColor="#fdf497" suppressHydrationWarning />
        <stop offset="0.05" stopColor="#fdf497" suppressHydrationWarning />
        <stop offset="0.45" stopColor="#fd5949" suppressHydrationWarning />
        <stop offset="0.6" stopColor="#d6249f" suppressHydrationWarning />
        <stop offset="0.9" stopColor="#285AEB" suppressHydrationWarning />
      </radialGradient>
    </defs>
...
export const getBrandLogo = (platform, className = "w-5 h-5") => {
  ...
  if (plat.includes("twitter") || plat.includes("x")) return <XLogo className={className} />;
